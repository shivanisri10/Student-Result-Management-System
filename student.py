...
class studentClass:
    def __init__(self,root):
        ...
        lbl_admission=Label(self.root,text="Admit Date",font=("goudy old style",15,'bold'),bg='white').place(x=370,y=140)
        ...
        btn_search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="#033054",fg="white",cursor="hand2",command=self.search).place(x=1070,y=60,width=120,height=28)
