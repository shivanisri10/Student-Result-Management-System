...
class Register:
    def __init__(self, root):
        ...
        bg_lbl = Label(self.root, image=self.bg).place(x=0, y=0, relwidth=1, relheight=1)

        # Left Image (Social Impact)
        self.left = ImageTk.PhotoImage(file="images/side.png")
        left_lbl = Label(self.root, image=self.left).place(x=80, y=100, width=400, height=500)
